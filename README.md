...
Bitte arbeiten Sie aktiv am [Wiki](https://github.com/fhswf/PG-KILL/wiki) mit!
...
- Visual Studio Code installieren
  - [Tailwind CSS IntelliSense Extension](https://marketplace.visualstudio.com/items?itemName=bradlc.vscode-tailwindcss) installieren
...
```
Zum Aufsetzen des Backends siehe die [Readme.md](./backend/readme.md) im backend Ordner.
